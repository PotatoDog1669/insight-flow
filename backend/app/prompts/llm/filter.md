...
- For posts from official social accounts, keep high-signal updates even when they are not classic press releases if they contain concrete product, workflow, API, tooling, rollout, policy, or actionable technical guidance.
...
- For social sources, use `author_username` / `author_name` as part of the decision. Personal chatter, podcasts, movie reactions, and generic conversation should still be dropped unless they include a concrete new AI development.
