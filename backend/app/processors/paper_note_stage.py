"""Shared paper note stage execution helpers."""
...
async def run_paper_note_with_retry(
    *,
    route: StageRoute,
    ...
    for provider_name in provider_chain:
        ...
        provider = provider_getter(stage="paper_note", name=provider_name)
    ...
    if last_exc is not None:
        raise last_exc
    raise RuntimeError("paper_note stage has no available provider")
